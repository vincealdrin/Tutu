...
FAKE_AYLIEN_APP_ID = os.environ.get('AYLIEN_APP_ID')
FAKE_AYLIEN_APP_KEY = os.environ.get('AYLIEN_APP_KEY')
FAKE_AYLIEN_APP_ID2 = os.environ.get('AYLIEN_APP_ID2')
FAKE_AYLIEN_APP_KEY2 = os.environ.get('AYLIEN_APP_KEY2')
FAKE_AYLIEN_APP_ID3 = os.environ.get('AYLIEN_APP_ID3')
FAKE_AYLIEN_APP_KEY3 = os.environ.get('AYLIEN_APP_KEY3')
